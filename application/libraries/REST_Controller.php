...
abstract class REST_Controller extends CI_Controller
{
	...
	*/
	...
	{
		//Change the GDC Id
		if(array_key_exists("gdc_id", $this->_post_args))
		{
			$strGdcId = trim(str_replace("g", "", $this->_post_args['gdc_id']));
			$this->_post_args['gdc_id'] = trim(str_replace("G", "", $strGdcId));
		}
		if(array_key_exists("GDCId", $this->_post_args))
		{
			$strGdcId = trim(str_replace("g", "", $this->_post_args['GDCId']));
			$this->_post_args['GDCId'] = trim(str_replace("G", "", $strGdcId));
		}
	}
